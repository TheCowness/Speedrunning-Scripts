...
FROM dragonwarrioriii_monsters
ORDER BY Number ASC
";
execute($db_query);
...
0x7D => "Stick Slime",
0x7E => "Black Raven",
0x7F => "" //Vaxherd's notes say 7F equates to no item drop (think chests are the same) instead of "Sword Horned"
);
...
All of this data is mined from the ROM, but was compared against this document: <a href="http://www.angelfire.com/comics2/fatboy9175/DW3Bestiary.txt">http://www.angelfire.com/comics2/fatboy9175/DW3Bestiary.txt</a>.<br>
<br>
Actual regen ranges: 16-23, 45-55, 90-109<br>
<br>
Resistance Values translate to: 0/256 resistant, 77/256, 179/256, 256/256 = 100% effective, 30% eff, 70% eff, 0% eff.<br>
<br>
AI Type Abbreviations:<br>
<U>U</U>nweighted: 25% chance of hitting each character.<br>
<U>N</U>ormal: 44%/40%/15%/1% chance of hitting each character. (Or 45/43/12, or 57/43)<br>
<U>S</U>mart: as Normal, but attack target is determined when monster's action comes up.<br>
<U>C</U>oncentrated: All concentrating monsters will attack same character.<br>
The "Concentrated" flag from my data doesn't match the doc above exactly, and I don't know how the U/N/S flag interacts with this flag.<br>
<br>
If a monster takes 1-2 actions, the second action happens 50% of the time.<br>
If a monster takes 1-3 actions, there is a 25% chance of one attack, 37.5% chance of two, and 37.5% of three.<br>
<br><br>
<?php 
